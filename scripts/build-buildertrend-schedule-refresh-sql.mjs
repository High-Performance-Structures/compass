...
} from "./lib/buildertrend-schedule-refresh.mjs"
...
if (dryRun) {
  process.stdout.write(`${JSON.stringify(summarizeBuildertrendScheduleRefresh(fixture), null, 2)}\n`)
} else {
  await writeFile(
    resolve(outputPath),
    generateBuildertrendScheduleRefreshSql(fixture),
    "utf8",
  )
}
