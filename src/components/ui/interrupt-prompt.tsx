    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="absolute left-1/2 flex -translate-x-1/2 overflow-hidden whitespace-nowrap rounded-md border bg-background py-1 text-center text-sm text-muted-foreground"
        >
