...
describe("Foxit estimate envelopes", () => {
  it("creates an unsent embedded-preparation envelope with every signer", async () => {
    ...
    const result = await createFoxitPreparedEnvelope({
      ...
      fields: [
        ...
        },
        {
          ...
          party: 1,
          partyResponsible: 1,
          name: "Signature - Client 1",
          tooltip: "Client 1: signature",
          required: true,
        },
        {
          type: "date",
          ...
          party: 1,
          partyResponsible: 1,
          name: "Date signed - Client 1",
          tooltip: "Client 1: date signed",
          required: true,
          fontSize: 10,
    ...
    expect(body?.fields).toEqual([
      ...
      expect.objectContaining({ type: "signature", party: 1, required: true }),
