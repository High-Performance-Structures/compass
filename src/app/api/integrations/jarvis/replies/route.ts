...
export async function POST(request: Request): Promise<Response> {
  ...
  // Keep the source claim in processing until the caller acknowledges with the
  // replacement token returned below. This preserves a retryable crash window;
  // message and inbound-event ids are deterministic, so a reclaimed event is
  // replay-safe.
