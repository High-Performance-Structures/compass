/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 45df8074b9e8dd29566132e6492442a3)
// Runtime types generated with workerd@1.20260526.1 2026-08-20 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	ASSETS: Fetcher;
	CLOUDFLARE_ACCOUNT_ID: "8716137c706ea3d5c209b330084fa9e2";
	COMPASS_PUBLIC_BASE_URL: "https://compass.openrangeconstruction.ltd";
	GIFTBIT_ENVIRONMENT: "testbed";
	GIFTBIT_ORDERING_ENABLED: "false";
	SOCIAL_PUBLIC_BASE_URL: "https://compass.openrangeconstruction.ltd";
	...
	SAGE_SQUARE_PAYMENT_WRITES_ENABLED: "false";
	YOUTUBE_API_AUDIT_APPROVED: "true";
	AGENT_AUTH_SECRET: string;
	CLOUDFLARE_API_TOKEN: string;
	COMPASS_EMAIL_SYNC_SECRET: string;
	GITHUB_FEEDBACK_PROJECT_ID: string;
	GITHUB_REPO: string;
	GITHUB_TOKEN: string;
	...
	GOOGLE_PROJECT_MANAGER_HANDOFF_TOKEN: string;
	GOOGLE_SERVICE_ACCOUNT_ENCRYPTION_KEY: string;
	GOTO_CLIENT_ID: string;
	GOTO_CLIENT_SECRET: string;
	GOTO_SMS_ACCOUNT_NAME: string;
	GOTO_SMS_ACCESS_TOKEN: string;
	GOTO_SMS_FROM_NUMBER: string;
	GOTO_WEBHOOK_SECRET: string;
	META_APP_ID: string;
	META_APP_SECRET: string;
	FOXIT_ESIGN_CLIENT_ID: string;
	FOXIT_ESIGN_CLIENT_SECRET: string;
	FOXIT_ESIGN_WEBHOOK_SECRET: string;
	JARVIS_BRIDGE_ORGANIZATION_ID: string;
	JARVIS_BRIDGE_SECRET: string;
	JARVIS_SERVICE_USER_ID: string;
	NEXT_PUBLIC_WORKOS_REDIRECT_URI: string;
	OPENROUTER_API_KEY: string;
	SAGE_BRIDGE_SECRET: string;
	SAGE_PAY_APPLICATION_BRIDGE_SECRET: string;
	...
	LISTENING_ROOM_COORDINATOR: DurableObjectNamespace<import("./custom-worker").ListeningRoomCoordinator>;
	WORKER_SELF_REFERENCE: Service<typeof import("./custom-worker").default>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./custom-worker");
		durableNamespaces: "ListeningRoomCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "COMPASS_PUBLIC_BASE_URL" | "GIFTBIT_ENVIRONMENT" | "GIFTBIT_ORDERING_ENABLED" | "SOCIAL_PUBLIC_BASE_URL" | "REALTIMEKIT_APP_ID" | "WORKOS_REDIRECT_URI" | "WORKOS_COOKIE_MAX_AGE" | "JARVIS_AGENT_BRIDGE_ENABLED" | "SAGE_CLIENT_PROJECT_WRITES_ENABLED" | "SAGE_SQUARE_PAYMENT_CUTOFF_AT" | "SAGE_SQUARE_PAYMENT_WEBHOOK_ENABLED" | "SAGE_SQUARE_PAYMENT_WRITES_ENABLED" | "YOUTUBE_API_AUDIT_APPROVED" | "AGENT_AUTH_SECRET" | "CLOUDFLARE_API_TOKEN" | "COMPASS_EMAIL_SYNC_SECRET" | "GITHUB_FEEDBACK_PROJECT_ID" | "GITHUB_REPO" | "GITHUB_TOKEN" | "GOOGLE_OAUTH_CLIENT_ID" | "GOOGLE_OAUTH_CLIENT_SECRET" | "GOOGLE_OAUTH_REDIRECT_URI" | "GOOGLE_OAUTH_TOKEN_ENCRYPTION_KEY" | "GOOGLE_PROJECT_MANAGER_HANDOFF_TOKEN" | "GOOGLE_SERVICE_ACCOUNT_ENCRYPTION_KEY" | "GOTO_CLIENT_ID" | "GOTO_CLIENT_SECRET" | "GOTO_SMS_ACCOUNT_NAME" | "GOTO_SMS_ACCESS_TOKEN" | "GOTO_SMS_FROM_NUMBER" | "GOTO_WEBHOOK_SECRET" | "META_APP_ID" | "META_APP_SECRET" | "FOXIT_ESIGN_CLIENT_ID" | "FOXIT_ESIGN_CLIENT_SECRET" | "FOXIT_ESIGN_WEBHOOK_SECRET" | "JARVIS_BRIDGE_ORGANIZATION_ID" | "JARVIS_BRIDGE_SECRET" | "JARVIS_SERVICE_USER_ID" | "NEXT_PUBLIC_WORKOS_REDIRECT_URI" | "OPENROUTER_API_KEY" | "SAGE_BRIDGE_SECRET" | "SAGE_PAY_APPLICATION_BRIDGE_SECRET" | "SOCIAL_TOKEN_ENCRYPTION_KEY" | "SQUARE_PRODUCTION_ACCESS_TOKEN" | "SQUARE_WEBHOOK_SIGNATURE_KEY" | "WORKOS_API_KEY" | "WORKOS_CLIENT_ID" | "WORKOS_COOKIE_PASSWORD" | "X_CLIENT_ID" | "X_CLIENT_SECRET">> {}
}
