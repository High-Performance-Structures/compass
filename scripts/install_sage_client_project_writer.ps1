...
$contactSource = Join-Path $PSScriptRoot "Sage.100.Contractor.CompassContactWriter.cs"
...
& $compiler /nologo /optimize+ /target:exe /out:$binary /reference:System.Data.dll /reference:System.Web.Extensions.dll $source $contactSource
